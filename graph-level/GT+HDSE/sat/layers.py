...
class Attention(gnn.MessagePassing):
    ...
    def __init__(self, embed_dim, num_heads=8, dropout=0., bias=False,
        ...
        self.attn_sum = None
        # self.cnn = nn.Embedding(100, num_heads)
    ...
    def message(self, v_j, qk_j, qk_i, edge_attr, index, ptr, size_i, return_attn, dist):

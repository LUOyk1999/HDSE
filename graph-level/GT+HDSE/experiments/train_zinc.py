...
def main():
    ...
    train_dset = GraphDataset(datasets.ZINC(data_path, subset=True,
        ...
        use_subgraph_edge_attr=args.use_edge_attr, data_path=data_path, train='train', hdse=args.hdse)
    ...
    val_dset = GraphDataset(datasets.ZINC(data_path, subset=True,
        ...
        use_subgraph_edge_attr=args.use_edge_attr, data_path=data_path, train='val', hdse=args.hdse)
    ...
    test_dset = GraphDataset(datasets.ZINC(data_path, subset=True,
        ...
        use_subgraph_edge_attr=args.use_edge_attr, data_path=data_path, train='test', hdse=args.hdse)
    ...
    for epoch in range(args.epochs):
        ...
        print('best_val_loss',best_val_loss,best_test_loss)

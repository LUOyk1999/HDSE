...
def main():
    ...
    train_dset = GraphDataset(datasets.GNNBenchmarkDataset(data_path,
        ...
        cache_path=cache_path + 'train', data_path=data_path+'/'+args.dataset, train='train', hdse=args.hdse)
    input_size = n_tags
    train_loader = DataLoader(train_dset, batch_size=args.batch_size, shuffle=True, num_workers=2)
    ...
    val_dset = GraphDataset(datasets.GNNBenchmarkDataset(data_path,
        ...
        cache_path=cache_path + 'val', data_path=data_path+'/'+args.dataset, train='val', hdse=args.hdse)
    ...
    test_dset = GraphDataset(datasets.GNNBenchmarkDataset(data_path,
        ...
        cache_path=cache_path + 'test', data_path=data_path+'/'+args.dataset, train='test', hdse=args.hdse)
